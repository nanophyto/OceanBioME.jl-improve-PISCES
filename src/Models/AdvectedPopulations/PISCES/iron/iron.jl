...
@inline function iron_tendency(iron::SimpleIron,
                               ...
                               microzooplankton_iron_ratio,
                               microzooplankton_non_assimilated_fraction,
                               microzooplankton_maximum_grazing_rate,
                               microzooplankton_temperature_sensitivity,
                               microzooplankton_preference_for_p,
                               microzooplankton_preference_for_d,
                               microzooplankton_preference_for_z,
                               microzooplankton_preference_for_poc,
                               microzooplankton_specific_food_threshold_concentration,
                               microzooplankton_grazing_half_saturation,
                               microzooplankton_food_threshold_concentration,
                               microzooplankton_minimum_growth_efficiency,
                               microzooplankton_maximum_flux_feeding_rate,
                               mesozooplankton_iron_ratio,
                               mesozooplankton_non_assimilated_fraction,
                               mesozooplankton_maximum_grazing_rate,
                               mesozooplankton_temperature_sensitivity,
                               mesozooplankton_preference_for_p,
                               mesozooplankton_preference_for_d,
                               mesozooplankton_preference_for_z,
                               mesozooplankton_preference_for_poc,
                               mesozooplankton_specific_food_threshold_concentration,
                               mesozooplankton_grazing_half_saturation,
                               mesozooplankton_food_threshold_concentration,
                               mesozooplankton_minimum_growth_efficiency,
                               mesozooplankton_maximum_flux_feeding_rate,
                               mesozooplankton_quadratic_mortality,
                               Fe,
                               DOC,
                               T,
                               POC,
    ...
    small_particle_iron_remineralisation = degradation(Val(:SFe),
                                                        specific_degradation_rate(base_breakdown_rate,
                                                                                  ...
                                                                                  O₂_min_2),
                                                        SFe)
    grazing_waste = non_assimilated_iron(microzooplankton_iron_ratio,
                                         microzooplankton_non_assimilated_fraction,
                                         microzooplankton_maximum_grazing_rate,
                                         microzooplankton_temperature_sensitivity,
                                         microzooplankton_preference_for_p,
                                         ...
                                         sinking_flux,
                                         sinking_iron_flux)
    upper_trophic_waste = upper_trophic_dissolved_iron(mesozooplankton_minimum_growth_efficiency,
                                                       mesozooplankton_non_assimilated_fraction,
                                                       mesozooplankton_iron_ratio,
                                                       mesozooplankton_temperature_sensitivity,
                                                       mesozooplankton_quadratic_mortality,
